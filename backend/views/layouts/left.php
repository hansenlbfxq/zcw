...
<nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <!-- <li <?php if(in_array($rq_controller,['users','order'])){?>class="active" <?php }?>>
                        <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">业务管理</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li <?php if(in_array($rq_controller,['users'])){?>class="active" <?php }?>><a href="<?=Url::to(['users/index']) ?>">会员管理</a></li>
                             <li <?php if(in_array($rq_controller,['order'])){?>class="active" <?php }?>><a href="<?=Url::to(['order/index']) ?>">订单管理</a></li>
                        </ul>
                    </li> -->
                    ...
                    <li <?php if(in_array($rq_controller,['member','setting'])){?>class="active" <?php }?>>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="<?=Url::to(['setting/index']) ?>">基本设置</a></li>
                        </ul>
                    </li>
